...
<div>
    <div>
        <p>
            Une petite présentation du projet, pour que vous sachiez ce qu'on fait !!
        </p>
        <h1>Le projet</h1>
        <p>
